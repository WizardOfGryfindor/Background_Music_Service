package com.example.musicplayer_backgroundservice;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUI(Button btnPlay, TextView textView) {
        ...
        btnPlay.setText(isBackgroundSoundServiceRunning ? "Stop" : "Play");
        textView.setText(isBackgroundSoundServiceRunning ?
                "Click to stop!" :
                "Click to play!");
        textView.setTextColor(Color.parseColor(isBackgroundSoundServiceRunning ? "#FF0000" : "#008000"));
    }
